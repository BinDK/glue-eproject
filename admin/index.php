                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="index.php?page=dien">Animal</a> 
                                    <a class="nav-link" href="index.php?page=admin_category">Category</a>
                                    <a class="nav-link" href="index.php?page=admin_gallery">Gallery</a>
                                    <a class="nav-link" href="index.php?page=admin_event">Event</a>
                                    <a class="nav-link" href="index.php?page=admin_ticket">Ticket</a>
                                </nav>
                            </div>
