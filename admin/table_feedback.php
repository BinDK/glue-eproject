...
while ($feedback = mysqli_fetch_array($result)) { 
    ...
    ?>
            <tr role="row" class="<?= $even_this_Shit ?>">
                ...
                <td align="center"><a href="edit_product.php?id=<?= $feedback['id'] ?>">Answer</a> |
                <a onclick="return confirm('Are you really want to delete it??')" href="index.php?id=<?= $feedback['id']?>&action=delete">Delete</a>
                </td>
            </tr>
    <?php } ?>
</tbody>
